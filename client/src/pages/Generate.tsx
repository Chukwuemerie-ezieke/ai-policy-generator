...
const aiToolOptions = [
  {
    id: "chatbots",
    label: "AI Chatbots",
    sub: "ChatGPT, Gemini, Copilot",
    icon: <MessageSquare size={18} />,
  },
  {
    id: "edtech",
    label: "EdTech Platforms",
    sub: "Adaptive tutoring, AI grading",
    icon: <BookOpen size={18} />,
  },
  {
    id: "schoolmgmt",
    label: "School Management AI",
    sub: "Attendance, timetabling, Harmony Suite",
    icon: <Building2 size={18} />,
  },
  {
    id: "contentgen",
    label: "AI Content Generation",
    sub: "Text, images, video, deepfakes",
    icon: <Image size={18} />,
  },
];
...
const frameworkOptions = [
  {
    id: "ndpr",
    label: "NDPA / NDPR",
    sub: "Nigeria Data Protection Act 2023",
    color: "#01696F",
  },
  {
    id: "iso42001",
...
export default function Generate() {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      mode: "school",
      consultantOrg: "",
      aiTools: ["chatbots", "edtech"],
      frameworks: ["ndpr", "iso42001"],
    },
  });
  ...
  const toggleArr = (field: "aiTools" | "frameworks", val: string) => {
    ...
    setValue(
      field,
      cur.includes(val) ? cur.filter((v: string) => v !== val) : [...cur, val],
    );
  };
            ...
            <div className="step-card">
                  ...
                  {[
                    {
                      val: "school",
                      label: "School Mode",
                      sub: "For school heads & admins",
                    },
                    {
                      val: "consultant",
                      label: "Consultant Mode",
                      sub: "For ICT consultants managing multiple schools",
                    },
                  ].map((m) => (
                    <div
                      key={m.val}
                      data-testid={`mode-${m.val}`}
                      onClick={() =>
                        setValue("mode", m.val as "school" | "consultant")
                      }
              ...
              {mode === "consultant" && (
                <div className="mb-4">
                  ...
                  <Input
                    {...form.register("consultantOrg")}
                    placeholder="e.g. Harmony Digital Consults Ltd"
                    data-testid="input-consultantOrg"
                  />
                </div>
              )}
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g. Ufuma Community Secondary School"
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      { val: "tertiary", label: "Tertiary" },
                    ].map((t) => (
                      <button
                        key={t.val}
                        type="button"
                        data-testid={`type-${t.val}`}
                        onClick={() =>
                          setValue(
                            "schoolType",
                            t.val as "primary" | "secondary" | "tertiary",
                          )
                        }
                        style={{
                          flex: 1,
                          padding: "0.5rem",
                          borderRadius: 8,
                          border: `2px solid ${watch("schoolType") === t.val ? "hsl(var(--primary))" : "hsl(var(--border))"}`,
                          background:
                            watch("schoolType") === t.val
                              ? "hsl(var(--accent))"
                              : "hsl(var(--card))",
                          fontWeight: 600,
                          fontSize: "0.85rem",
                ...
                <div className="flex gap-4">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      {...form.register("boardingSchool")}
                      data-testid="check-boarding"
                      className="w-4 h-4"
                    />
                  ...
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      {...form.register("hasIctLab")}
                      data-testid="check-ictlab"
                      className="w-4 h-4"
                    />
              ...
              <div className="grid grid-cols-1 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g. Mr. Chukwuemeka Obi"
                    data-testid="input-principalName"
                  />
                ...
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Full name (leave blank if not yet designated)"
                    data-testid="input-dpoName"
                  />
                </div>
                <div>
                  <Label className="mb-1 block text-sm font-medium">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {[
                      ...
                      <div
                        key={a.val}
                        data-testid={`age-${a.val}`}
                        onClick={() =>
                          setValue(
                            "studentAgeGroup",
                            a.val as "under18" | "mixed" | "over18",
                          )
                        }
                        className={`tool-card flex-1 text-center ${watch("studentAgeGroup") === a.val ? "selected" : ""}`}
                        style={{ cursor: "pointer" }}
                      >
            ...
            <div className="step-card">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  >
                    Select all that apply — each gets dedicated policy clauses
                  </p>
                </div>
              </div>
                    ...
                    <div className="ml-auto">
                      <div
                        style={{
                          ...
                          height: 20,
                          borderRadius: "50%",
                          border: `2px solid ${aiTools.includes(tool.id) ? "hsl(var(--primary))" : "hsl(var(--border))"}`,
                          background: aiTools.includes(tool.id)
                            ? "hsl(var(--primary))"
                            : "transparent",
                          display: "flex",
                          alignItems: "center",
              ...
              {form.formState.errors.aiTools && (
                <p
                  className="text-xs mt-2"
                  style={{ color: "hsl(var(--destructive))" }}
                >
                  Select at least one AI tool category
                </p>
              )}
            </div>
          )}
            ...
            <div className="step-card">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  >
                    Select frameworks to include in the policy
                  </p>
                </div>
              </div>
                    ...
                    <div className="ml-auto">
                      <div
                        style={{
                          ...
                          height: 20,
                          borderRadius: "50%",
                          border: `2px solid ${frameworks.includes(fw.id) ? "hsl(var(--primary))" : "hsl(var(--border))"}`,
                          background: frameworks.includes(fw.id)
                            ? "hsl(var(--primary))"
                            : "transparent",
                          display: "flex",
                          alignItems: "center",
              ...
              >
                ...
                >
                  ...
                  <div>
                    <strong>Head:</strong> {watch("principalName") || "—"}
                  </div>
                  <div>
                    <strong>AI Tools:</strong> {aiTools.length} selected
                  </div>
                  <div>
                    <strong>Frameworks:</strong> {frameworks.length} selected
                  </div>
                </div>
              </div>
            </div>
            ...
            {step < TOTAL_STEPS ? (
              ...
              >
                {isGenerating ? (
                  ...
                  <>
                    <Layers size={16} className="mr-2" /> Generate Policy
                  </>
                )}
              </Button>
            )}
